    ...
    <div class="wrapper"  style="background-image: url(css/photos/birds-cold-conifer-917494.jpg);">
     ...
     <div class="sidebar-wrapper">
                <div class="logo">
                   ...
                   echo " <img class='img-circle' src=".$row[3] ." width='140' style='margin-left: 40px'> ";         echo "<br>"; 
                echo "Welcome ".$row[4];} }
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title"> Mes demandes de réservations </h4>
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                $query="SELECT * FROM demande where id_user= ".$_SESSION['id']."; ";
                                                   if ($result=mysqli_query($DB,$query))
                                                    {
                                                    ...
                                                    while ( $row=mysqli_fetch_array($result))

                                                     {
                                                                ...
                                                                //7days uwu 
                                                                 ...
                                                                 $datedb=$row[5];
                                                                 $now=time();
                                                                 $date1=strtotime($datedb);
                                                                 $r=($date1-$now)/(60*60*24);
                                                                 if (($r>=7)&&($row[14]==0))
                                                                 {
                                                            echo "<tr>  
                                                                  ...
                                                                  <td> <a href='annuler.php?dem=".$row[0]."' target='_blank' <i class='nc-icon nc-simple-remove' ;> </td>
                                                                     <td> <i class='nc-icon nc-stre-right' ;> "."</td>
                                                                         <td> <a <i class='nc-icon nc-stre-right' id=".$row[0]." onclick='iddem(this.id,\"frm10\",\"i2\")'>  </td>
                                                                </tr>";
                                                               
                                                                
                                                                  echo "<form id='frm10' method='POST' action='info.php'><input id='i2'name='idm' type='hidden' value=".$row[0]."/></form>
                                                                   ...
                                                                   echo "<tr>  
                                                                    ...
                                                                    <td>".$row[9]."</td> 
                                                                     ...
                                                                     <td> <a href='annuler.php?dem=".$row[0]."' target='_blank' <i class='nc-icon nc-simple-remove' ;> </td>
                                                                        ...
                                                                        <td> <i id='icon' class='fas fa-exclamation'></i></td>
